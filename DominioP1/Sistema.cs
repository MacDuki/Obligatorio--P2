...
public class Sistema
{
    ...
    //VARIABLE PARA VALIDAR QUE NO SE HAYAN PRECARGADO LOS DATOS. 
    public static bool datosPrecargados = false; 
    ...
    //MÉTODO PARA PROCESAR UNA OFERTA RECIBIDA DESDE EL CONTROLADOR. 
    public void ProcesarOferta(Cliente? unCliente, Subasta? unaSubasta, float monto)
    {

        try
        {
            unaSubasta.RealizarOferta(unCliente, monto, DateTime.Now); 
